...
import { Box, Center, Text, Image, VStack, ButtonGroup, Button, Stack } from '@chakra-ui/react';
...
export default function Hero(props: HeroProps) {
  return (
    <Box minH={{ base: '70vh', sm: '80vh', lg: '100vh' }} bg={'#f9c150'} position={'relative'} pt={{ base: '10rem', md: '20rem', lg: '10rem' }}>
      ...
      <Center w={'100%'}>
        <Image position={'absolute'} w={'clamp(200px, 70vw, 453px)'} h={'clamp(0px, 50vw, 305px)'} src='/assets/logo/battle-logo.png' alt='Kelas Pintar' />
      ...
      <Center>
        <Text textAlign={'center'} pt={'6rem'} px={'2em'} fontSize={'25px'} color={'#264991'} fontWeight={600}>
