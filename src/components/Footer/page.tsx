...
export default function Footer() {
  return (
    <Box bgColor={'#234990'} color={'#ffffff'} py={10} px={{base: 10, md: 20, '2xl': '200px'}}>
      <Text mb={5}>Home /</Text>
      <SimpleGrid columns={{base: 1, md: 2, lg: 3}}>
        <Box display="flex" flexDirection="column">
          <Text mb={5} mt={{base: 10, lg: 0}} fontWeight={600}>Kelas Pintar Indonesia</Text>
        ...
        <Box display="flex" flexDirection="column">
          <Text mb={5} mt={{base: 10, lg: 0}} fontWeight={600}>Solusi Belajar</Text>
        ...
        <Box display="flex" flexDirection="column">
          <Text mb={5} mt={{base: 10, lg: 0}} fontWeight={600}>Tentang Kami</Text>
          <Box display="flex" flexDirection="row" gap={10}>
            <VStack align='stretch'>
