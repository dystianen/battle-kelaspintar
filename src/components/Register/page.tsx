              ...
              <FormControl>
                <SimpleGrid columns={{base: 1, md: 2}}>
                  ...
                  <HStack alignItems={'start'} gap={'10px'}>
                    ...
                    <Input {...register("name", {required: true})} placeholder={'Nama Lengkap'} bgColor={'#e3ebfe'}
                           border={'0.1px'} borderRadius='30px'/>
                  </HStack>
                </SimpleGrid>
              </FormControl>
                ...
                <SimpleGrid columns={{base: 1, md: 2}}>
                  ...
                  <HStack alignItems={'start'} gap={'10px'}>
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder={'(yang terhubung dengan WhatsApp)'}
                      bgColor={'#e3ebfe'}
                      border={'0.1px'}
                      borderRadius='30px'
                    />
                  ...
                  <HStack alignItems={'start'} gap={'10px'}>
                    ...
                    <InputGroup size='md'>
                      ...
                      <InputRightElement width='4rem'>
                        {show ? <Icon onClick={handleShow} as={IoMdEye}/> :
                          <Icon onClick={handleShow} as={IoMdEyeOff}/>}
                      </InputRightElement>
                    </InputGroup>
                  </HStack>
                </SimpleGrid>
              ...
              <FormControl>
                <Box>
                  <Grid
                    ...
                    gap={5}
                  >
                    <GridItem colSpan={1} alignSelf={{base: 'end', md: 'start'}}>
